...
public class VideoActivity extends BaseCallActivity {
    ...
    private void initVideo() {
        ...
        setupLocalPreview();
        String token = getString(R.string.rtc_token);
        //joinRtcChannel(token, mChannel, "", Integer.parseInt(config().getUserId()));
        joinRtcChannel(token, "M2", "", Integer.parseInt(config().getUserId()));
    }
