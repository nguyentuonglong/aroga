...
public abstract class BaseCallActivity extends BaseRtcActivity implements RtmChannelListener, ResultCallback<Void> {
    ...
    public void onMemberCountUpdated(int count) {
        Log.i("BaseCallActivity", "onMemberCountUpdated");
    }
    ...
    public void onMessageReceived(RtmMessage rtmMessage, RtmChannelMember rtmChannelMember) {
        Log.i("BaseCallActivity", "onMessageReceived");
    }

    @Override
    public void onMemberJoined(RtmChannelMember rtmChannelMember) {
        Log.i("BaseCallActivity", "onMemberJoined");
    }

    @Override
    public void onMemberLeft(RtmChannelMember rtmChannelMember) {
        Log.i("BaseCallActivity", "onMemberLeft");
    }

    @Override
    public void onSuccess(Void aVoid) {
        Log.i("BaseCallActivity", "onSuccess");
    }

    @Override
    public void onFailure(ErrorInfo errorInfo) {
        Log.i("BaseCallActivity", "onFailure");
    }
